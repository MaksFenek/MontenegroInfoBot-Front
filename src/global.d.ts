// Extends https://github.com/prKassad/telegram-webapps-types
// Actual types for Bot API 6.2
export declare namespace TelegramWebApps {
  ...
  type PopupButtonTypes = "default" | "ok" | "close" | "cancel" | "destructive";

  type HapticFeedbackStyle = "light" | "medium" | "heavy" | "rigid" | "soft";

  type HapticFeedbackType = "error" | "success" | "warning";
  ...
  interface WebApp {
    ...
    /**
     *  method that opens an invoice using the link url. The Web App will receive the event invoiceClosed when the invoice is closed. If an optional callback parameter was passed, the callback function will be called and the invoice status will be passed as the first argument.
     */
     ...
     */
    showAlert(message: string, cb: Function): void;
    /**
     ...
     */
    showConfirm(message: string, cb: Function): void;
    /**
...
- soft, indicates a collision between soft or flexible UI objects.
     */
    impactOccurred(style: HapticFeedbackStyle);
    /**
 ...
 */
    notificationOccurred(type: HapticFeedbackType);
    /**
